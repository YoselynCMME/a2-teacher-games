        ...
        if ($(".groupColeccion").length) {
            ...
            $('.btnToggleColeccion2').click(function (e) {
                ...
                if ($('.capsulaActividad').css('top') == '27px') {
                    $('.capsulaActividad').animate({top: '152px'}, 800);
                    $(this).addClass("active");
                }
                else {
                    $('.capsulaActividad').animate({top: '27px'}, 800);
...
function loaded() {myScroll = setTimeout(function () {new iScroll('wrapper', {zoom: true})}, 8000);}
...
function entrarPantallaCompleta() {try {if (parent.innerWidth < 800) {launchFullScreen(document.documentElement);}} catch (err) {}}
